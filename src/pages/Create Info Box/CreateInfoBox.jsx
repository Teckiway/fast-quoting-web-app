...
import './CreateInfoBox.css';
import {AiOutlineArrowLeft} from 'react-icons/ai';
import CreatePriceEditor from '../../components/CreatePriceEditor/ServicePriceBoxEditor';
import AlertComponent from '../../components/AlertComponent/AlertComponent';
import {useHistory, useLocation} from 'react-router-dom';
import CreateQuoteInfoBox from '../../components/CreateQuoteInfo/CreateQuoteInfo'
import { useEffect } from 'react';
import CreateQuoteInfo from '../../components/CreateQuoteInfo/CreateQuoteInfo';
    ...
    return (
        <div>
            <div className="navigation-inner">
                ...
                <CreateQuoteInfo handleAlertPresentTrue = {()=>handleAlertPresentTrue()} handleAlertPresentFalse={()=>handleAlertPresentFalse()} handleAlertMessage = {(value)=>handleAlertMessage(value)}   handleAlertType = {(value)=>{handleAlertType(value)}} />
            </div>
        </div>
    )
}
