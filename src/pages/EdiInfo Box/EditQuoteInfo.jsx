...
import EditQuoteInfoCom from '../../components/EditQuoteInfo/EditQuoteInfo'
    ...
    return (
        <div>
            <div className="navigation-inner">
                ...
                <EditQuoteInfoCom handleAlertPresentTrue = {()=>handleAlertPresentTrue()} handleAlertPresentFalse={()=>handleAlertPresentFalse()} handleAlertMessage = {(value)=>handleAlertMessage(value)}   handleAlertType = {(value)=>{handleAlertType(value)}} />
            </div>
        </div>
    )
}
