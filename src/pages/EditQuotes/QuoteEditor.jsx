...
const handleQuoteSave = ()=>{
    const quoteObject = {
        ...
        "infoBoxObject" : infoBoxObjects,
        "numberOfItems": numberOfItems,
        "numberOfInfoBox": numberOfInfoBox,
        "targetContact": finalContactObject,
        "subTotal":subTotal,
        "taxTotal": taxTotal,
        "totalSum":totalSum,
        "taxState":taxState,
    ...
    setSavedButtonClicked(true)

    firestore.collection("Quotes").doc(quoteId).set(quoteObject).then(data=>{
        setSavedButtonClicked(false)
        setAlertMessage("Quote Saved Successfully")
        setAlertPresent(true)
        setAlertType(true)
    })
}
...
const handleQuoteTitle= (value)=>{
    ...
    <button className='saveButton' onClick={()=>handleQuoteSave()} >{saveButtonClicked ? <SmallSpinnerComponent/> : 'Save'}</button>
                <button className='cancelQuoteButton'>Cancel</button>
            </div><br/><br/><br/><br/>
            ...
            <div className='settings-section'>
                ...
                </div>
                {
                   moreSettingsClicked ? <div className='more-settings-div'>
                       <div>
                       <p>Date</p>
                    <input type="text" name="" className='paymentDue-box' onChange={(event)=>handleDueDate(event.target.value)} placeholder={fullDate} />
                       </div>
                       <div>
                       <p>From</p>
